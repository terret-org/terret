...
the kernel primitives (`docs/hames-primer.md`) and ends at a running
piece of a Terret: a real gem, real metadata, a real test. No recipe
stops at a snippet in isolation. Where a recipe touches a contract, it
points at the normative document for the contract and stays a how-to
itself.
